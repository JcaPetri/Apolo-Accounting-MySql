...
CREATE DATABASE `accountingdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs */ /*!80016 DEFAULT ENCRYPTION='N' */;

Main Structure of all Microservices
Group: com.apolo
Name: system / articles / persons / users / accounting

## Acounting Microservices
This microservices has the information about the business accounting:

The microservice can specialize:
1.- Register all the accounting.
2.- To make taxes settled.
...
## DATA BASE STRUCTURE
The data base structure has two main sections. 
- The first contain the tables of this microservices, with all the specific data information.
- The second contain the mirrors tables, that belong to other microservices but their information is needed by the current microservices. Ex. SysBaseElements_Tbl or SysEntityStructures_Tbl.

### Accounting Structure
Used to create the main elements (In this tables we create all tables of the Microservices)
 - AccDataElements_Tbl	--> Contains the diccionary of all articles data elements of the Microservice.
 - AccDataElementOtherFields_Tbl	--> Contains the optional fields/columns of the data elements.
 - AccDataElementLanguages_Tbl	--> Contains the meaning of the diccionary in another languages than the default.
 - AccDataElementComments_Tbl	--> Contains one or more comments/details/explains of each record of the diccionary.

### General Structure
Used to store the information of other microservices.
 - SysBaseElements_Mir	--> Contains the diccionary of all articles data elements of the Microservice.
 - SysEntityStructures_Mir	--> Contains the Structure of all table of this Microservice.

> [!TIP]
> The information stored in this tables, ushually do not change frecuently. But it is necesary to become this Microservices more independent.
...
- ***Used to create the Mirror Tables***
    - ***AccSysBaseElements_Mir*** --> Contains the MIRROR of the diccionary of all system elements of the Microservice.
    - ***ArtSysEntityStructures_Mir*** --> Contains the MIRROR of the accounting Microservice Entity Structure.
~~~
